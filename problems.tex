...
\phantomsection
\addcontentsline{toc}{section}{Unit 1: Python basics}
...
\phantomsection
\addcontentsline{toc}{section}{Unit 2: Simple programs}
...
\end{table}
  ...
  \subsection*{Problem 1 - Paying Debt off in a Year }
	\phantomsection
  	\addcontentsline{toc}{subsection}{Problem 1: Paying debp}
